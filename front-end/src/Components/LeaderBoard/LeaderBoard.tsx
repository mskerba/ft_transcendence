        ...
        <div className='leaderboard-page'>
                ...
                {sortedUsers.length > 0 && sortedUsers.map((user, _index) => (
                    ...
                    >
                        ...
                        <div className='leaderboard-username-avatar'>
                            <img className='leaderboard-avatar' src={`http://10.14.4.8:3000/avatar/${user.avatar}`} />
            ...
            <div className='leaderboard-userinfo'>
                {sortedUsers.length > 0 &&
                    <>
                        <img className='leaderboard-userinfo-avatar' src={`http://10.14.4.8:3000/avatar/${sortedUsers[index].avatar}`} />
