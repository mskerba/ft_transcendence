          ...
          <div className='profile-exit'>
            <li>
              <Link to={`/user/${authUser.userId}`} className="link">
                <img src={`http://10.14.5.10:3000/avatar/${authUser.avatar}`} className='profile-button-navbar' />
              </Link>
            </li>
        ...
        <div className='search-result'>
          {result.map((e: any, i) => (
            ...
            (e.userId) ?
              ...
              >
                <img src={`http://10.14.5.10:3000/avatar/${e.avatar}`} className='profile-button-navbar' />
                <h3>
                  {e.name}
                </h3>
              </div>
