...
const UserOptionsNavBar = ({option, onStateChange}: any) => {
    ...
    return (
        <nav className='user-options-navbar'>
            <div className={option == 0 ? 'user-options-navbar-button active' : 'user-options-navbar-button'}
            ...
            <div className={option == 1 ? 'user-options-navbar-button active' : 'user-options-navbar-button'}
            ...
            <div className={option == 2 ? 'user-options-navbar-button active' : 'user-options-navbar-button'}
            ...
            <div className={option == 3 ? 'user-options-navbar-button active' : 'user-options-navbar-button'}
            ...
            <div className={option == 4 ? 'user-options-navbar-button active' : 'user-options-navbar-button'}
            ...
            <div className={option == 5 ? 'user-options-navbar-button active' : 'user-options-navbar-button'}
